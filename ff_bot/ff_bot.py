...
def random_phrase():
    phrases = ['-The first season of Regulation Fantasy Football was in 2012 and won by Matt Jerikovsky, giving the initial rise of Pay Me.',
               ...
               '-Team Shit the Bed, known for throwing away seasons, has a trophy named after him worth 2 trophy stars.',
               '-big foot once paid 88 free agent auction dollars for Tarik Cohen.. Or something.',
               ...
               '-The worst record for any season is 0-13 by Darkness Loomerzzz in season 7.',
               ...
               '-Fer da sizzler.',
               '-Pay Me was not convicted for collusion, instead, the CPC issued punishments for other rule violations.',
               '-Does the bed shit?',
               ...
               '-The CPC (rulebook) and data for Regulation Gold is in a 4.5MB package of 13 Folders and over 100 files',
               ...
               '-What part of see you in august don\'t you understand?',
               '-Impeach!',
               ...
               '-Live draft in Vegas?',
               '-The Season 5 trophy won by Calvin Logan was misprinted. It\'s missing "season 5" and only displays: "Regulation".',
               '-Mornin niggers.',
               ...
               '-Pro tip: If you type "Pay Me is Pay Out" 5 times he appears in an enraged form.',
               ...
               '-The idea of one high paying trophy, with rewards upwards of 10 trophy stars was discussed, but ultimately scrapped.',
               ...
               '-It\'s confirmed impossible to make a trade with every owner in the league in one season.. Try it, I dare ya.',
               ...
               '-Error. Something went GAY, time to suck cock!.',
               '-I QUIT!',
               ...
               '-Pout and Out: When someone rages so hard they quit and go silent.',
               '-I\'m only scared of one thing... The rope.',
               '-First you chat, then you pipe.',
               '-Regulation didn\'t use PPR or decimal scoring until season 4.',
               '-FIRST TO WORST! #F2W',
               '-During CPC meetings, where serious collusion accusation and rule violations are discussed, rarely is anyone sober.',
               '-Waivers process every Wednesday, Friday, Saturday at 8pm Central. Send all complaints to Pay Me.',
               '-Don\'t blow your whole FA auction bank after week 1.. I\'ve seen how that ends up..',
               '-The Commish works at a gas station where he pumps gas for customers.',
               '-If I win, it\'s skill. If I lose, you got lucky.',
               '-Two things are certain: Pay me is pay out.. And the bed shits.',
               '-Legend says that season 1 was just a trial and the victor should\'t be credited due to lack of competition.',
               '-If Pay Me is alone in the woods, does it still pay out?',
               '-When you recieve a player via trade from The Oracle, a spell is placed on that player, granting him on the IR within a week.',
               '-The great trade embargo.. I will never forget.',
               '-Hans..Get the stamp.',
               '-EAT DICK',
               '-Where\'s the firesale?',
               '-Matt Ryan a.k.a. THE DUMB WHITE NIGGER',
               '-THE GREAT ONE FOR A REASON',
               '-WHOLE TEAM ON BLOCK, EVERYTHING MUST GO',
               '-Always check the injury reports before accepting a trade from The Oracle..',
               '-Owner makes a trade with The Oracle, player received gets injured, many such cases!',
               '-Stupid fucking commish making up rules as we go.',
               '-Setting a protest line up can, and will, get you booted from the league!',
               '-I hope (insert opponent\'s star player) dies in a car crash tonight.',
               '-Dumbass LM never predicts me to win, what a fuckin idiot.',
               '-You are awarded 2 trophy stars just for being active in this chat with me <3',
               '-Don\'t forget about the gambling option! Should be posted on league page every odd week. Unless dumb fuck commish forgot.',
               '-The trophy race prize will likely increase in the future. Good luck trophy racers.',
               '-Nobody remembers season one because most of the owners are not even in the league anymore.',
               '-In season 8, the Wall of Champions was replaced with the Top 8 Leaderboard for a better display of league winners.',
               '-You can always check the current cash paid out data by clicking the link on the front page.'
               '-Regulation Trivia: What RB was nicknamed "The Superstar"?',
               '-Regulation Trivia: What WR was nicknamed "The Knee"?',
               '-Regulation Trivia: What RB was nicknamed "The Crow"?',
               '-BUILD WALL',
               '-Regulation Trivia: What QB was nicknamed "The Hometown Hero"?',
               '-In season 5, Calvin defeated The Oracle by less than one point in the semi finals. He would go on to win the championship vs Brock.',
               '-Shitty league, even shittier LMs.',
               '-I\'m just a bot that loves to shitpost tbh.',
               '-Your opinion matters. LOL.',
               '-Season 6 was the year of CASTRO.',
               '-All trades are approved with the certified stamp from The Oracle.',
               '-Playoff bye weeks were removed in season 5.',
               '-TING, trade alert from The Oracle.. Again!',
               '-My duds your studs. You know the drill.',
               '-All changes to the league are made democratically, through polls and discussions. YEAH RIGHT LMFAO',
               '-Remember, you\'re here forever.',
               '-PUSH IT',
               '-Can\'t wait for next August. I\'ll be able to see you again.',
               '-Every year Cole texts the commish during the draft to speed up the time, which he ignores.',
               '-Just because it\'s not in the rules, doesn\'t mean the commish can\'t do it.',
               '-Draft day is a week long holiday in my house.',
               '-If you want to be in the discord for future drafts, just ask!',
               '-If you suspect collusion, notify a LM or the commish. You could be awarded for ousting colluders!',
               '-Pay Me was penalized for falsly accusing someone of collusion, a direct rule violation. Don\'t make the same mistake!',
               '-The draft date will always be decided by a poll. If you don\'t vote, don\'t bitch about the date!',
               '-The trophy race is designed to reward owners who are active, participate in the league to have a better chance to win the prize!',
               '-Three weekly trophies are always awarded: Biggest Win, Man of the Week, and Lowest Score. There are some others, but seldom rewarded.',
               '-The head to head chalice trophy is awarded to whoever defeats the current holder.',
               '-Being Team Most Points Against has its advantages. In season 7, the TMPA trophy was enough to put Tyler Logan over the top to win the trophy race!',
               '-Pay Me will undoubtedly fly to cali to beat commish\'s ass.',
               '-I can post pictures, I just don\'t want to.',
               '-I just need a nuclear bomb to go off in Seattle tonight and I\'ll secure the W for this week.',
               '-Lol at the fags who stay sober for the draft.',
               '-We can make that trade, what\'s the cut? 70/30? My troph tho',
               '-Your season is NOT over until you see 8 losses.',
               '-Regulation Gold is unionized. 2 CPC members represent the league during times of need.',
               '-By far, season 8 seen the LEAST amount of trades.',
               '-In season 8, MERICA B-DITTY became the second owner to ever be removed from the league by LMs due to protest line-ups.']
...
##################################THIS IS RANDOMSAY##############################################################################
    ...
    sched.add_job(bot_main, 'cron', ['get_projected_scoreboard'], id='projected_scoreboards',
        day_of_week='mon,tue,wed,thu,fri,sat', hour='11,14,20,22', minute=5, start_date=ff_start_date, end_date=ff_end_date,
