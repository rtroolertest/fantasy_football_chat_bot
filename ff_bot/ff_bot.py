...
def random_phrase():
    phrases = ['-The first season of Regulation Fantasy Football was in 2012 and won by Matt Jerikovsky, giving the initial rise of Pay Me.',
               ...
               '-The CPC was created specifically to thwart collusion, later this group and document was expanded on to entail every rule in the league.',
               ...
               '-random.choice(paymefact)print(fact)..... lol pay me is pay out.',
               ...
               '-Legend says that season 1 was just a trial, the victor should\'t be credited for lack of competition.',
               '-If Pay Me is alone in the woods, does he still pay out?',
               '-So far, there is over 125 archived responses I can choose from. I guess I picked this one.',
               '-When you recieve a player via trade from The Oracle, a spell is placed on that player, placing him on the IR within a week.',
               ...
               '-Nobody remembers season one because most of the owners are not in the league anymore.',
               ...
               '-Trivia: What RB in the NFL had the nickname "The Muscle Hamster"?',
               '-BUILD WALL',
               ...
               '-My duds your studs ONLY!',
               '-Ya\'ll are lucky I don\'t have a fantasy team.. You fucking losers SUCK.',
               '-All changes to the league are made democratically, through polls and discussions. YEAH RIGHT LMFAO',
               '-Remember, you\'re here forever.',
               '-PUSH IT',
               '-Without me, this chat would be boring af.',
               ...
               '-Pay Me will undoubtedly fly to cali to beat the commish\'s ass. post pics!!',
               '-I can post pictures, I just don\'t want to.',
               '-How to code 101, hosted by commish. Cost: Your WR1.',
               ...
               '-Generally, big changes to the league are brought to CPC members before they are implemented.',
...
##################################THIS IS RANDOMSAY##############################################################################
    ...
    sched.add_job(bot_main, 'cron', ['get_projected_scoreboard'], id='projected_scoreboards',
        day_of_week='mon,tue,wed,thu,fri,sat', hour='11,14,17,20', minute='5,55', start_date=ff_start_date, end_date=ff_end_date,
